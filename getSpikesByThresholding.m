...
% multiply by voltage_sign
   ...
   sinds      = arrayfun(@(i) toVec( Spike_start_ind(i):(Spike_start_ind(i)+Spike_duration(i))), ...
                              1:length(Spike_start_ind), 'uniformoutput', false); 
   stimes     = arrayfun(@(i) toVec(time(Spike_start_ind(i):(Spike_start_ind(i)+Spike_duration(i)))), ...
                              1:length(Spike_start_ind), 'uniformoutput', false); 
