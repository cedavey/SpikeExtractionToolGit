...
function str = getTooltips(objectName)
   ...
   tooltips = struct(...
      ...
      'new_figure_workspace',                'Loads the voltage into a variable in the workspace and plots it on a figure',               ...
      ...
      'run_tool_utilities',                  'Merge or truncate voltage timeseries',                                                      ...
